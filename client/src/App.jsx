      ...
      <div>
        ...
        <Container>
          ...
          <Row className="mt-4">
            <Col className="" md={{ span: 7, offset: 1 }}>
              <ProductParagraph
                MAWproductSlogan={this.state.MAWproductData.slogan}
                MAWproductDescription={this.state.MAWproductData.description}
              />
            </Col>
            <Col
              sm={{ span: 4, offset: 0 }}
            ...
            >
              <ProductFactoids
                MAWproductFactoids={this.state.MAWproductData.features}
              />
            </Col>
          </Row>
        </Container>
